...
import sty from "./PlasmicButton.module.css"; // plasmic-import: VLjK03XBepNB/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames("all", sty.freeBox__uRdbx, {
          [sty.freeBoxcolor_neutral__uRdbxwo2Qt]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxroundedFull__uRdbxSfkE]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__uRdbxE0Oj3]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__uRdbxuMsA0]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__uRdbxNLn]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__uRdbxZbc0P]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__uRdbx1R3CM]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__uRdbx1R3CMNDjZ]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames("all", sty.freeBox__eMv2H, {
            [sty.freeBoxcolor_neutral__eMv2Hwo2Qt]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__eMv2Hg5ZjB]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__eMv2He0Oj3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__eMv2HnLn]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__eMv2Hzbc0P]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__eMv2H1R3CM]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__eMv2HOh7UdWo2Qt]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames("all", sty.svg___9HoFh)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          defaultContents: (
            <div className={classNames("all", "__wab_text", sty.text__qMgki)}>
              {"Text"}
            </div>
          ),
        ...
        <div
          className={classNames("all", sty.freeBox__i7Oe, {
            [sty.freeBoxiconEnd__i7OEu7MwN]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__i7Oee0Oj3]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__i7OenLn]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__i7Oezbc0P]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames("all", sty.svg__pgIlN)}
                role={"img"}
              />
            ),
